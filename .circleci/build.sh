...
git clone --depth=1 https://github.com/stormbreaker-project -b rebase X01AD
git clone --depth=1 https://github.com/xyz-prjkt/xRageTC-clang clang

# Main
KERNEL_NAME=GLKernel-Test # IMPORTANT ! Declare your kernel name
...
DEVICE_DEFCONFIG=X01AD-defconfig # IMPORTANT ! Declare your kernel source defconfig file here.
